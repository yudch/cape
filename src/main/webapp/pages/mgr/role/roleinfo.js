define([ 'jquery', 'knockout', 'text!pages/mgr/role/roleinfo.html'],
	function($, ko, template) {
		...
		viewModel.submitForm = function(){
			var saveUrl = $ctx + '/mgr/role/create';
			if(viewModel.data().id != 0){
				saveUrl = $ctx + '/mgr/role/update';
			} 
		...
		var loadData = function(id) {
			var infoUrl = $ctx + '/mgr/role/create';
			if(id && id!=0){
				infoUrl = $ctx + '/mgr/role/update/' + id;
			}
			$.ajax({
				type: 'GET',
				url: infoUrl,
